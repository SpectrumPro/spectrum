...
func _set_zone_override(p_zone: String, p_override: bool) -> void:
	...
	zone_select.get_popup().set_item_icon_modulate(_zone_indexes[p_zone], ThemeManager.Colors.Statuses.DataOverride if p_override else Color.WHITE)
...
func _set_button_override(p_button: BaseButton, p_override: bool) -> void:
	...
	if p_override:
		p_button.add_theme_color_override("font_color", ThemeManager.Colors.Statuses.DataOverride)
		p_button.add_theme_color_override("font_focus_color", ThemeManager.Colors.Statuses.DataOverride)
		p_button.add_theme_color_override("font_pressed_color", ThemeManager.Colors.Statuses.DataOverride)
		p_button.add_theme_color_override("font_hover_color", ThemeManager.Colors.Statuses.DataOverride)
		p_button.add_theme_color_override("font_hover_pressed_color", ThemeManager.Colors.Statuses.DataOverride)
	else:
